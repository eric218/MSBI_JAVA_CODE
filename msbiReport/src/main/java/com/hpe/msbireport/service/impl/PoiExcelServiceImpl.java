...
public class PoiExcelServiceImpl implements PoiExcelService {
    ...
    public String generateExcelFileToAFixedPath(Integer monthIndicator, String path,String type) throws Exception {
        {
            ...
            List<TotalSummary> totalSummaries = commonUtils.computeSummaryForMonthReportContent(monthReports);
            List<LookupSummary> lookupSummaries = commonUtils.computeSummaryForMonthReportLookup(monthReports);

            List<MonthReport> monthReportsNonProd = this.monthReportMapper.selectAllMonthReportsByMonthForNon_Prod(monthIndicator);
    ...
    public void createDailyAndNonProdSheetsForWorkbook(HSSFWorkbook workbook,
                                                       ...
                                                       List<TotalSummary> totalSummaries,
                                                       List<LookupSummary> lookupSummaries) throws Exception {
